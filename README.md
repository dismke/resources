...
- [Diagramming tools](#-diagramming-tools-for-cloud-architecture)
- [Scrapers](#-scrapers)
...
- [Pagebuilders](#-pagebuilders---elementor)
...
- [GO](https://roadmap.sh/golang) - Go developer Roadmap
- [Python](https://roadmap.sh/python) - Python Developer Roadmap
...
- [Lucidchart](https://www.lucidchart.com/) - Lucidchart is the intelligent diagramming application
- [Draw.io](https://www.draw.io/) - free online diagram software
- [Diagrams.net](https://www.diagrams.net/) - everything you expect from a professional diagramming tool
- [Gliffy](https://www.lucidchart.com/) - diagramming tool

### 🛠 SCRAPERS

- [PhantomBuster](https://phantombuster.com/) - Generate leads from all major networks & websites
- [Siteright](https://www.siteright.co/) - Capture & Convert Leads Automatically
- [BuildWith](https://builtwith.com/) - Find out what websites are Built With
- [The hive index](https://thehiveindex.com/) - A directory of online communities
...
- [Ionic Blocks](https://ionicblocks.com/) - Select code snippets from a library of templates. - build Ionic apps in minutes
...
- [Gitignore generator](https://www.toptal.com/developers/gitignore) - Create useful .gitignore files for your project
...
- [Elementor](https://developers.elementor.com/) - Elementor Developers Documentation Center. Here, you’ll find detailed documentation, clearly explaining how developers can leverage the wide-range of tools and options Elementor provides them.
- [Divi](https://www.elegantthemes.com/developers/)

### ⚡ JAVASCRIPT

- [Learn javascript online](https://learnjavascript.online/) - Learn in an interactive environment. Read short lessons, take notes, and complete challenges directly in your browser.
...
- [Developer guides](https://developer.android.com/guide) - These documents teach you how to build Android apps using APIs in the Android framework and other libraries.
...
- [Kotlin course](https://www.tutorialspoint.com/kotlin/index.htm) - Basics of kotlin
...
- [Laravel](https://www.tutorialspoint.com/laravel/index.htm) - Application framework with expressive, elegant syntax.
...
- [StackOverflow](https://stackoverflow.com/) - Every developer has a tab open to Stack Overflow
- [Build your own x](https://codecrafters.io/) - Create your favorite technologies from scratch.
- [Zeroops](https://contabo.com/en/zerops/) - Get Projects up and Running in the Blink of an Eye!
- [Buildspace](https://buildspace.so/) - Buildspace accelerates your builder journey into web3
...
- [ Docker WSL](https://docs.docker.com/desktop/windows/wsl/) -Docker Desktop WSL 2 backend
- [Kubernetes & Docker](https://kubernetes.io/blog/2020/05/21/wsl-docker-kubernetes-on-the-windows-desktop/) -  Kubernetes on the Windows Desktop
...
- [App academy](https://www.appacademy.io/) - experts at training people with zero coding experience
- [Kotlin bootcamp](https://www.udacity.com/course/kotlin-bootcamp-for-programmers--ud9011) - Learn the essentials of the Kotlin programming language from Kotlin experts at Google.
